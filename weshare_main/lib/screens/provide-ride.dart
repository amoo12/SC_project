                            ...
                            child: Card(
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  RideDetails('Choose Riders Gender',
                                      gender != null, Icons.people, [
                                    Column(
                                      children: <Widget>[
                                        Row(
                                          mainAxisAlignment:
                                  ...
                                  RideDetails('Add a Note (Optional)',
                                      notes != null, Icons.comment, [
                                    Column(
                                      children: <Widget>[
                                        SizedBox(
                                          width: MediaQuery.of(context)
                                ...
                                onPressed: () async {
                                  ...
                                  if (_formKey.currentState.validate() &&
                                    ...
                                    SnackBar registrationBar = SnackBar(
                                      content: Text(
                                        'Please make sure you fill up the whole form!',
                                      ),
                                    );
